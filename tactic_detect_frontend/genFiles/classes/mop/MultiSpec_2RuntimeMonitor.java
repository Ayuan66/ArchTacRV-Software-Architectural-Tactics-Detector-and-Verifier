...
public final class MultiSpec_2RuntimeMonitor implements com.runtimeverification.rvmonitor.java.rt.RVMObject {
	private static com.runtimeverification.rvmonitor.java.rt.map.RVMMapManager MultiSpec_2MapManager;
	static {
		MultiSpec_2MapManager = new com.runtimeverification.rvmonitor.java.rt.map.RVMMapManager();
		MultiSpec_2MapManager.start();
	}

	// Declarations for the Lock
	static final ReentrantLock MultiSpec_2_RVMLock = new ReentrantLock();
	static final Condition MultiSpec_2_RVMLock_cond = MultiSpec_2_RVMLock.newCondition();
	...
	public static final void PingEcho_pingEvent() {
		...
		while (!MultiSpec_2_RVMLock.tryLock()) {
			Thread.yield();
		}
