...
class ExceptionTimeMonitor extends com.runtimeverification.rvmonitor.java.rt.tablebase.AbstractAtomicMonitor implements Cloneable, com.runtimeverification.rvmonitor.java.rt.RVMObject {
	...
	static final int Prop_1_transition_ping[] = {2, 3, 2, 3};;
	static final int Prop_1_transition_echo[] = {0, 3, 0, 3};;
	static final int Prop_1_transition_exception[] = {1, 3, 2, 3};;
	...
	final boolean Prop_1_event_ping() {
		...
		int nextstate = this.handleEvent(0, Prop_1_transition_ping) ;
		this.ExceptionTimeMonitor_Prop_1_Category_violation = nextstate == 1;
...
class PingEchoMonitor extends com.runtimeverification.rvmonitor.java.rt.tablebase.AbstractAtomicMonitor implements Cloneable, com.runtimeverification.rvmonitor.java.rt.RVMObject {
	...
	static final int Prop_1_transition_ping[] = {2, 3, 2, 3};;
	static final int Prop_1_transition_echo[] = {1, 3, 0, 3};;
	static final int Prop_1_transition_exception[] = {0, 3, 0, 3};;
	...
	final boolean Prop_1_event_ping() {
		...
		int nextstate = this.handleEvent(0, Prop_1_transition_ping) ;
		this.PingEchoMonitor_Prop_1_Category_violation = nextstate == 1;
...
class PingEchoExceptionMonitor extends com.runtimeverification.rvmonitor.java.rt.tablebase.AbstractAtomicMonitor implements Cloneable, com.runtimeverification.rvmonitor.java.rt.RVMObject {
	...
	static final int Prop_1_transition_exception[] = {1, 1, 3, 3};;
	static final int Prop_1_transition_handleexception[] = {2, 0, 3, 3};;
	...
	final boolean Prop_1_event_exception() {
		...
		this.PingEchoExceptionMonitor_Prop_1_Category_violation = nextstate == 2;
...
public aspect MultiSpec_1MonitorAspect implements com.runtimeverification.rvmonitor.java.rt.RVMObject {
	...
	pointcut PingEcho_echo() : (call(* send_echo(..))) && MOP_CommonPointCut();
	before () : PingEcho_echo() {
		//ExceptionTime_echo
		MultiSpec_1RuntimeMonitor.ExceptionTime_echoEvent();
		//EchoXorException_echo
		MultiSpec_1RuntimeMonitor.EchoXorException_echoEvent();
		//PingEcho_echo
		MultiSpec_1RuntimeMonitor.PingEcho_echoEvent();
	}

	pointcut PingEcho_ping() : (call(* send_ping(..))) && MOP_CommonPointCut();
	before () : PingEcho_ping() {
		//ExceptionTime_ping
		MultiSpec_1RuntimeMonitor.ExceptionTime_pingEvent();
		//EchoXorException_ping
		MultiSpec_1RuntimeMonitor.EchoXorException_pingEvent();
		//PingEcho_ping
		MultiSpec_1RuntimeMonitor.PingEcho_pingEvent();
	}

	pointcut PingEcho_exception() : (call(* server_exception(..))) && MOP_CommonPointCut();
	after () : PingEcho_exception() {
		//PingEcho_exception
		MultiSpec_1RuntimeMonitor.PingEcho_exceptionEvent();
		//PingEchoException_exception
		MultiSpec_1RuntimeMonitor.PingEchoException_exceptionEvent();
		//EchoXorException_exception
		MultiSpec_1RuntimeMonitor.EchoXorException_exceptionEvent();
		//ExceptionTime_exception
		MultiSpec_1RuntimeMonitor.ExceptionTime_exceptionEvent();
	}

	pointcut PingEchoException_handleexception() : (call(* handle_exception(..))) && MOP_CommonPointCut();
	after () : PingEchoException_handleexception() {
		MultiSpec_1RuntimeMonitor.PingEchoException_handleexceptionEvent();
	}
