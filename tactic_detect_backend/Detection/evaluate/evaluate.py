...
def n_fold_evaluate(model, train_data, train_label, k_neighbours, cv=10):
    ...
    for train_idx, test_idx in data_gen:  # 循环10次
        ...
        y_pred_prob = model.predict_proba(X_Test)  # 预测得分
        ...
        sum_MCC = sum_MCC + MCC
        sum_OVR = sum_OVR + AUC_OVR
        sum_OVO = sum_OVO + AUC_OVO
    print("\n")
    print("平均准确率：")
